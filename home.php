...
<section id="blog" class="py-24 md:py-32 bg-background">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- Header -->
    <div id="blog-header" class="mb-16">
    ...
    <!-- Articles -->
    <?php if (have_posts()) : ?>
      <div id="blog-articles" class="space-y-12">
        ...
        ?>
          <article class="blog-article group cursor-pointer border-b border-border pb-12 last:border-b-0">
            <a href="<?php the_permalink(); ?>" class="block">

              <div class="blog-article-bar h-1 w-16 bg-foreground mb-6"></div>
              ...
              <h2 class="blog-article-title text-2xl md:text-3xl font-bold text-foreground mb-4 leading-tight">
                <?php the_title(); ?>
              </h2>
      ...
      <?php if (get_next_posts_link() || get_previous_posts_link()) : ?>
        <div id="blog-pagination" class="mt-16 pt-8 border-t border-border flex items-center justify-between">
          <div>
            <?php if (get_previous_posts_link()) : ?>
              <a id="blog-prev" href="<?php echo esc_url(get_previous_posts_page_link()); ?>"
          ...
          <div>
            <?php if (get_next_posts_link()) : ?>
              <a id="blog-next" href="<?php echo esc_url(get_next_posts_page_link()); ?>"
                class="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors font-medium">
                <span>Older</span>
